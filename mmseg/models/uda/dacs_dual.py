...
@UDA.register_module()
class DACSDual(UDADecorator):

    def __init__(self, **cfg):
        super(DACSDual, self).__init__(**cfg)
        self.local_iter = 0
    ...
    def forward_train(
        ...
        **kwargs
        ...
        clean_losses = self.get_model().forward_train(
            img, img_metas, gt_semantic_seg, return_feat=True, depth=gt_depth_map)
        ...
        ema_logits = self.get_ema_model().encode_decode(
            target_img, target_img_metas, depth=target_gt_depth_map) # 2*19*512*512 input size
        ...
        mix_losses = self.get_model().forward_train(
            mixed_img, img_metas, mixed_lbl, pseudo_weight, return_feat=True, depth=mixed_depth)
